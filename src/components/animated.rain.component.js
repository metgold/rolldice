...
import Dice from '../../assets/images/3ddice.png';
import { HomeBlackScreen } from '../features/home/homescreens/homeblack.screen';

const MONEY_DIMENSIONS = { width: 4, height: 2 };
...
const MakeItRain = ({ count = 4, duration = 3000 }) => (
  <ErlichBachman>
    {range(count)
      ...
      .map((flipDelay, i) => (
        <Falling
          ...
          <Swinging
            ...
            <FlippingImage source={Dice} delay={flipDelay} />
            <FlippingImage
              source={Dice}
              delay={flipDelay}
              back
